...
if( !class_exists('Digitalworld_MegaMenu')){
    class Digitalworld_MegaMenu{
        ...
        function __construct() {
            ...
            add_action( 'wp_head',array($this,'addShortcodesCustomCss_megamenu'),999 );
        ...
        public function megamenu_load_font_icon(){
            ...
            <div class="icons-popup">
                <div class="inner">
                    ...
                    <?php endforeach;?>
                    <?php else:?>
                        <?php esc_html_e('No Font','digitalworld');?>
                    <?php endif;?>
                </div>
            </div>
            <?php
        ...
        public  function addShortcodesCustomCss_megamenu( ) {
            ...
            if ( $posts_array ) {
                ...
                foreach( $posts_array as $post ){
                    ...
                    $shortcodes_custom_css.= get_post_meta( $post->ID, '_digitalworld_shortcode_custom_css', true );
                }

                if ( ! empty( $shortcodes_custom_css ) ) {
                    echo '<style type="text/css" data-type="digitalworld_megamenu_shortcodes-custom-css">';
