...
<header id="header" class="header style1">
                ...
                <div class="col-sm-6 hidden-sm hidden-xs hidden-ts">
                    <?php 
                        wp_nav_menu( array(
                            ...
                            'container_class' => '',
                            'container_id'    => '',
                            'menu_class'      => 'clone-main-menu digitalworld-nav main-menu center',
                            'fallback_cb'     => 'Digitalworld_navwalker::fallback',
                            'walker'          => new Digitalworld_navwalker()
                        ));
                     ?>
    ...
    $opt_enable_vertical_menu = digitalworld_option('opt_enable_vertical_menu', '1');
        ...
        <div class="container">
            <div class="header-nav-inner">
                <?php if( $opt_enable_vertical_menu == '1'):?>
                    ...
                    if( ($opt_click_open_vertical_menu == '0' ) && ( is_front_page() || ( isset($_GET['digitalworld_is_home']) && $_GET['digitalworld_is_home'] == 'true' ) ) || digitalworld_check_demo_is_homepage() ){
                ...
                <div class="box-header-nav">
                    ...
                    <?php digitalworld_search_form();?>
                    <?php if( $opt_hotline ):?>
                        <div class="hotline">
                            <?php echo balanceTags( trim($opt_hotline) );?>
                        </div>
                    <?php endif;?>
                </div>
            </div>
