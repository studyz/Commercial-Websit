...
class Digitalworld_Product_Categories extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'A list or dropdown of product categories.', 'digitalworld' );
		$this->widget_id          = 'digitalworld_woocommerce_product_categories';
		$this->widget_name        = __( 'Digitalworld : WooCommerce Product Categories', 'digitalworld' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Product Categories', 'digitalworld' ),
			...
			'orderby' => array(
				...
				'options' => array(
					'order' => __( 'Category Order', 'digitalworld' ),
					'name'  => __( 'Name', 'digitalworld' )
				)
			),
			'dropdown' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Show as dropdown', 'digitalworld' )
			),
			'count' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Show product counts', 'digitalworld' )
			),
			'hierarchical' => array(
				'type'  => 'checkbox',
				'std'   => 1,
				'label' => __( 'Show hierarchy', 'digitalworld' )
			),
			'show_children_only' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Only show children of the current category', 'digitalworld' )
			),
			'hide_empty' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Hide empty categories', 'digitalworld' )
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		// List
			...
			$list_args['show_option_none']           = __('No product categories exist.', 'digitalworld' );
